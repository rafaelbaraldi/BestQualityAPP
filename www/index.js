$(function(){
    ...
    function requestClientes(){
        ...
        // Executa ajax
        $.ajax({
            url: "http://www.mocky.io/v2/56d63a37100000932f4afe50",
            type: "GET",
            jsonp: "callback",
            dataType: "jsonp",
            success: function(data){
                ...
                for(i in data){
                    ...
                    $("#divSwiper").append("<div class=\"swiper-slide swiper-container-h\"><div class=\"swiper-wrapper\"><div class=\"swiper-slide\">" + cliente.nome + "</div><div class=\"swiper-slide\">Informações do cliente 1</div><div class=\"swiper-slide\">Promoções  do cliente 1</div><div class=\"swiper-slide\">Mapa do cliente 1</div></div><div class=\"swiper-pagination swiper-pagination-h\"></div></div>");
